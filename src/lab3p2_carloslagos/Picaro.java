...
public class Picaro extends Personajes{
    ...
    public Picaro(String tinstrumento, int cantrobos, int HP,int CS, int AC, int DG, int years, String nombre, String raza, String nacionalidad, String tipoP, double altura, double peso, String descripcion,String tpersonaje) {
    ...
    public String toString() {
        return super.toString() + "Picaro{" + "tinstrumento=" + tinstrumento + ", cantrobos=" + cantrobos + '}';
    }
